...
const getAllowedFormats = x =>
	x && x.getAllowedFormats ? x.getAllowedFormats() : null;
const getCurrentStyle = x =>
	x && x.getCurrentInlineStyle ? x.getCurrentInlineStyle() : null;
...
export default class CoreContextProvider extends React.Component {
	...
	getChildContext() {
		...
		return {
			...
			editor,
			toggleFormat(x) {
				editor.toggleInlineStyle(x, true);
			},
		};
	}
